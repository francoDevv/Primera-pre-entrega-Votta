respuesta = input("Deseas ver el menu de usuarios responde con si o no:")
respuseta_minuscula = respuesta.lower()
if (respuseta_minuscula == "no"):
    pass
elif (respuseta_minuscula == "si"):
    ...
    print("Por favor seleccione una respuesta valida")
